      ...
      return new Promise((resolve) => {
        if (!this.visitedRoutes.find((it) => it.path === route.path)) {
          ...
          if (route.name) {
            ...
            if (!cachedRoutesStore.cachedRoutes.includes(route.name)) {
              cachedRoutesStore.cachedRoutes.push(route.name)
            }
          }
